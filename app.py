...
def update_model_paths_for_cache():
    ...
    cache_mappings = [
        ...
        },
        {
            ...
            "local_default": "InfiniteTalk/weights/InfiniteTalk/single/single/single/infinitetalk.safetensors",
            "repo": "MeiGen-AI/InfiniteTalk",
            "filename": "single/single/single/infinitetalk.safetensors"
        }
    ]
...
MODEL_CONFIG = {
    ...
    "infinitetalk_dir": "InfiniteTalk/weights/InfiniteTalk/single/single/single/infinitetalk.safetensors",
...
def fix_broken_models():
    ...
    try:
        ...
        if not infinitetalk_file.exists():
            ...
            potential_files = [
                os.path.join(cache_base, "single", "single", "single", "infinitetalk.safetensors"),
